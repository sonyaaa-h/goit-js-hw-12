import{a as L,i as c,S as w}from"./assets/vendor-D0cagnvz.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();async function m(r,s=1){const i="47398520-23b63bacec280c041aa8780c5",a="https://pixabay.com/api/",{data:e}=await L(`${a}`,{params:{key:i,page:s,per_page:15,q:r,image_type:"photo",orientation:"horizontal",safesearch:!0}});return e}const g=r=>r.map(({webformatURL:s,largeImageURL:i,tags:a,likes:e,views:t,comments:n,downloads:y})=>`
